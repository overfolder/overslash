...
| 7.2.1 | HMAC-SHA256 over the raw body (consumer) and over the raw envelope (provider) | `have` | `routes/billing/webhook.rs:360-370`; `services/webhook_dispatcher.rs:111-121` |
| 7.2.3 | Timestamp tolerance on the consumer side | `have` | `routes/billing/webhook.rs:310-358` |
